...
//        InitiativeRepository.getInstance().deleteAllInitiative();
        ...
        i.add(new Initiative(1,"name","10/10/2021 10:10:00","10/12/2021 10:10:00","description","area","location", CommonUtils.getImagenInitiativeDefault(JointlyApplication.getContext()),
                "amount","douglas@gmail.com","123456",false,false));
//        i.add(new Initiative(2,"name","10/10/2021","10/12/2021","description","area","location", CommonUtils.getImagenInitiativeDefault(JointlyApplication.getContext()),"amount","status",
//                "email@gmail.com","123456",false,false));
...
//        j.add(new UserJoinInitiative(1, "douglas@gmail.com", false, false));
//        j.add(new UserJoinInitiative(2, "douglas@gmail.com", false, false));
